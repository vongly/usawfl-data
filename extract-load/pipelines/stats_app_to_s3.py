...
def run_pipeline(test=False):
    ...
    if test:
        ...
        os.environ['STATS_APP_TO_S3_TEST__DESTINATION__FILESYSTEM__BUCKET_URL'] = f's3://{pipeline_name}'
        os.environ['STATS_APP_TO_S3_TEST__DESTINATION__CREDENTIALS__ENDPOINT_URL'] = S3_ENDPOINT_URL
        os.environ['STATS_APP_TO_S3_TEST__DESTINATION__CREDENTIALS__AWS_ACCESS_KEY_ID'] = S3_ACCESS_KEY
        os.environ['STATS_APP_TO_S3_TEST__DESTINATION__CREDENTIALS__AWS_SECRET_ACCESS_KEY'] = S3_SECRET_ACCESS_KEY
        os.environ['STATS_APP_TO_S3_TEST__DESTINATION__CREDENTIALS__AWS_DEFAULT_REGION'] = S3_REGION
